...
public class Menu
{
    ...
    private readonly MenuItem _menuItemExit = new("E", "Exit",null);
    private readonly MenuItem _menuItemReturn = new("R", "Return", null);
    private readonly MenuItem _menuItemMain = new("M", "Main", null);
    ...
    public string? Run()
    {
        ...
        return input == _menuItemReturn.ShortCut.ToUpper() ? "" : input;
    }
